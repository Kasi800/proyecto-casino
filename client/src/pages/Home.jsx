  ...
  return (
    <body>
      <header>
        ...
        <a href="/login" class="buton">Iniciar Sesion</a>
      </header>
      ...
      <section>
          ...
          <p>Obtén bonos exclusivos al registrarte. ¡Duplica tu primera apuesta y empieza a ganar hoy!</p>
      </section>

      <footer>
          &copy; 2025 KasiNo | <a href="#">Términos</a> | <a href="#">Política de Privacidad</a>
      </footer>
    </body>
  );
}